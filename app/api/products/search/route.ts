...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${LARAVEL_API_BASE_URL}/products/search?q=${encodeURIComponent(query)}`, {
      headers: {
    ...
    console.error("Error searching products from Laravel API:", error)
